...
## -- Module  : howto_oa_ca_101_run_kmeans_2d_static_observed.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
if __name__ == '__main__':
    myscenario.task_observer.export_results_csv( p_file_name = os.path.join(os.path.expanduser("~"), 'cluster_analysis_results.csv' ) )
