...
## -- Module  : howto_oa_cd_ad_020_point_anomaly_detection_sad_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class ADPAScenarioSAD2D (OAStreamScenario):
    
    C_NAME = 'Point Anomaly Detection with StandardAbsoluteDeviation 2D'
...
myscenario = ADPAScenarioSAD2D( p_mode = Mode.C_MODE_REAL,
