...
## -- Module  : howto_oa_cd_ad_006_point_anomaly_detection_ocsvm_3d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class ADPAScenarioOCSVM3D (OAStreamScenario):
    
    C_NAME = 'Point Anomaly Detection with OneClassSVM 3D'
...
myscenario = ADPAScenarioOCSVM3D( p_mode = Mode.C_MODE_REAL,
