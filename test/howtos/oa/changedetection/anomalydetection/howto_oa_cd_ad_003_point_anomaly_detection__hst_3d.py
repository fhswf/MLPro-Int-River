...
## -- Module  : howto_oa_cd_ad_003_point_anomaly_detection_hst_3d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
class ADPAScenarioHST3D (OAStreamScenario):
    ...
    C_NAME = 'Point Anomaly Detection with Half Space Trees 3D'
...
myscenario = ADPAScenarioHST3D( p_mode = Mode.C_MODE_REAL,
