...
## -- Module  : howto_oa_cd_ad_012_point_anomaly_detection_lof_3d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class ADPAScenarioLOF3D (OAStreamScenario):
    
    C_NAME = 'Point Anomaly Detection with LocalOutlierFactor 3D'
...
myscenario = ADPAScenarioLOF3D( p_mode = Mode.C_MODE_REAL,
