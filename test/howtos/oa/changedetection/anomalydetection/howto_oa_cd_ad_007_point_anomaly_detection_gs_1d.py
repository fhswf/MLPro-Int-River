...
## -- Module  : howto_oa_cd_ad_007_point_anomaly_detection_gs_1d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class ADPAScenarioGS1D (OAStreamScenario):
    
    C_NAME = 'Point Anomaly Detection with GaussianScorer 1D'
...
myscenario = ADPAScenarioGS1D( p_mode = Mode.C_MODE_REAL,
