...
## -- Module  : howto_oa_cd_ad_019_point_anomaly_detection_sad_1d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
class ADPAScenarioSAD1D (OAStreamScenario):
    ...
    C_NAME = 'Point Anomaly Detection with StandardAbsoluteDeviation 1D'
...
myscenario = ADPAScenarioSAD1D( p_mode = Mode.C_MODE_REAL,
