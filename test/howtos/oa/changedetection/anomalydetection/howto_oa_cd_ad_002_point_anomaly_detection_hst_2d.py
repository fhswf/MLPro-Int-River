...
## -- Module  : howto_oa_cd_ad_002_point_anomaly_detection_hst_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class ADPAScenarioHST2D (OAStreamScenario):
    
    C_NAME = 'Point Anomaly Detection with Half Space Trees 2D'
...
myscenario = ADPAScenarioHST2D( p_mode = Mode.C_MODE_REAL,
