...
## -- Module  : howto_oa_cd_ad_011_point_anomaly_detection_lof_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
class ADPAScenarioLOF2D (OAStreamScenario):
    ...
    C_NAME = 'Point Anomaly Detection with LocalOutlierFactor 2D'
...
myscenario = ADPAScenarioLOF2D( p_mode = Mode.C_MODE_REAL,
