...
## -- Module  : howto_oa_cd_ad_005_point_anomaly_detection_ocsvm_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class ADPAScenarioOCSVM2D (OAStreamScenario):
    
    C_NAME = 'Point Anomaly Detection with OneClassSVM 2D'
...
myscenario = ADPAScenarioOCSVM2D( p_mode = Mode.C_MODE_REAL,
