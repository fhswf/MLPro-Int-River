...
## -- Module  : howto_oa_cd_ad_008_drift_detection_ddd_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
class DDScenarioDDD2D (OAStreamScenario):
    ...
    C_NAME = 'Drift Detection with DummyDriftDetector 2D'
...
myscenario = DDScenarioDDD2D( p_mode = Mode.C_MODE_REAL,
