...
## -- Module  : howto_oa_cd_ad_006_drift_detection_kswin_3d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class DDScenarioKSWIN3D (OAStreamScenario):
    
    C_NAME = 'Drift Detection with KSWIN 3D'
...
myscenario = DDScenarioKSWIN3D( p_mode = Mode.C_MODE_REAL,
