...
## -- Module  : howto_oa_cd_ad_011_drift_detection_ph_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class DDScenarioPH2D (OAStreamScenario):
    
    C_NAME = 'Drift Detection with PageHinkley 2D'
...
myscenario = DDScenarioPH2D( p_mode = Mode.C_MODE_REAL,
