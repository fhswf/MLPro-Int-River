...
## -- Module  : howto_oa_cd_ad_003_drift_detection_adwin_3d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class DDScenarioADWIN3D (OAStreamScenario):
    
    C_NAME = 'Drift Detection with ADWIN 3D'
...
myscenario = DDScenarioADWIN3D( p_mode = Mode.C_MODE_REAL,
