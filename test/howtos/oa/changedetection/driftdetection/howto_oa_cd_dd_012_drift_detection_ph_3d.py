...
## -- Module  : howto_oa_cd_ad_012_drift_detection_ph_3d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class DDScenarioPH3D (OAStreamScenario):
    
    C_NAME = 'Drift Detection with PageHinkley 3D'
...
myscenario = DDScenarioPH3D( p_mode = Mode.C_MODE_REAL,
