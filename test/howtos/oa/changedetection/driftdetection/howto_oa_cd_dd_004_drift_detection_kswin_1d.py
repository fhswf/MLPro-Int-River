...
## -- Module  : howto_oa_cd_ad_004_drift_detection_kswin_1d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class DDScenarioKSWIN1D (OAStreamScenario):
    
    C_NAME = 'Drift Detection with KSWIN 1D'
...
myscenario = DDScenarioKSWIN1D( p_mode = Mode.C_MODE_REAL,
