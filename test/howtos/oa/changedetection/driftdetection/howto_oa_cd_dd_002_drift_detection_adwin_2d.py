...
## -- Module  : howto_oa_cd_ad_002_drift_detection_adwin_2d.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## ------------------------------------------------------------------------------------------------
## ------------------------------------------------------------------------------------------------
class DDScenarioADWIN2D (OAStreamScenario):
    
    C_NAME = 'Drift Detection with ADWIN 2D'
...
myscenario = DDScenarioADWIN2D( p_mode = Mode.C_MODE_REAL,
