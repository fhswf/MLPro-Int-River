...
## -- Module  : howto_oa_ca_041_run_denstream_2d_static.py
## -------------------------------------------------------------------------------------------------
## -- History :
## -- yyyy-mm-dd  Ver.      Auth.    Description
## -- 2024-02-23  0.0.0     SY       Creation
## -- 2024-02-23  1.0.0     SY       First version release
...
from mlpro_int_river.wrappers.clusteranalyzers import WrRiverDenStream2MLPro
...
class Static2DScenario(OAScenario):
    ...
    def _setup(self, p_mode, p_ada: bool, p_visualize: bool, p_logging):
        ...
        workflow = OAWorkflow( p_name='Cluster Analysis using DenStream@River',
        ...
        # Cluster Analyzer
        task_clusterer = WrRiverDenStream2MLPro( p_name='#1: DenStream',
                                                p_decaying_factor=0.25,
                                                p_beta=0.75,
                                                p_mu=10,
                                                p_epsilon=0.02,
                                                p_n_samples_init=200,
                                                p_stream_speed=100,
                                                p_visualize=p_visualize,
                                                p_logging=p_logging )
